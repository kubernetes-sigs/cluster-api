	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterDeprecatedV1alpha1().MachineDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterDeprecatedV1alpha1().MachineDeployments(namespace).Watch(options)
			},
		},
		&deprecatedv1alpha1.MachineDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&deprecatedv1alpha1.MachineDeployment{}, f.defaultInformer)
}
