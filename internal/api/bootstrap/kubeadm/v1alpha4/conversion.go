...
func Convert_v1beta2_BootstrapToken_To_v1alpha4_BootstrapToken(in *bootstrapv1.BootstrapToken, out *BootstrapToken, s apimachineryconversion.Scope) error {
	...
	if !reflect.DeepEqual(in.Token, bootstrapv1.BootstrapTokenString{}) {
		...
		if err := autoConvert_v1beta2_BootstrapTokenString_To_v1alpha4_BootstrapTokenString(&in.Token, out.Token, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1alpha4_BootstrapToken_To_v1beta2_BootstrapToken(in *BootstrapToken, out *bootstrapv1.BootstrapToken, s apimachineryconversion.Scope) error {
	...
	if in.Token != nil {
		if err := autoConvert_v1alpha4_BootstrapTokenString_To_v1beta2_BootstrapTokenString(in.Token, &out.Token, s); err != nil {
			return err
		}
	}
	return nil
