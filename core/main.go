...
import (
	...
	"sigs.k8s.io/cluster-api/core/controllers/cluster"
	"sigs.k8s.io/cluster-api/core/controllers/clusterclass"
	"sigs.k8s.io/cluster-api/core/controllers/clusterresourceset"
	"sigs.k8s.io/cluster-api/core/controllers/clusterresourcesetbinding"
	"sigs.k8s.io/cluster-api/core/controllers/extensionconfig"
	"sigs.k8s.io/cluster-api/core/controllers/machine"
	"sigs.k8s.io/cluster-api/core/controllers/machinedeployment"
	"sigs.k8s.io/cluster-api/core/controllers/machinehealthcheck"
	"sigs.k8s.io/cluster-api/core/controllers/machinepool"
	"sigs.k8s.io/cluster-api/core/controllers/machineset"
