...
replace sigs.k8s.io/controller-runtime => github.com/sbueringer/controller-runtime v0.2.0-beta.1.0.20240806124912-9bf8d5dbba0b
...
require (
	...
	k8s.io/apiextensions-apiserver v0.31.0-rc.0
	...
	sigs.k8s.io/controller-tools v0.15.1-0.20240716085925-b1ff5ff78e15
...
require (
	...
	k8s.io/cluster-bootstrap v0.31.0-rc.0 // indirect
