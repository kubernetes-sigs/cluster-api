...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*UnhealthyMachineCondition)(nil), (*v1beta2.UnhealthyMachineCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_UnhealthyMachineCondition_To_v1beta2_UnhealthyMachineCondition(a.(*UnhealthyMachineCondition), b.(*v1beta2.UnhealthyMachineCondition), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.UnhealthyMachineCondition)(nil), (*UnhealthyMachineCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_UnhealthyMachineCondition_To_v1alpha4_UnhealthyMachineCondition(a.(*v1beta2.UnhealthyMachineCondition), b.(*UnhealthyMachineCondition), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha4_UnhealthyMachineCondition_To_v1beta2_UnhealthyMachineCondition(in *UnhealthyMachineCondition, out *v1beta2.UnhealthyMachineCondition, s conversion.Scope) error {
	out.Type = in.Type
...
// Convert_v1alpha4_UnhealthyMachineCondition_To_v1beta2_UnhealthyMachineCondition is an autogenerated conversion function.
func Convert_v1alpha4_UnhealthyMachineCondition_To_v1beta2_UnhealthyMachineCondition(in *UnhealthyMachineCondition, out *v1beta2.UnhealthyMachineCondition, s conversion.Scope) error {
	return autoConvert_v1alpha4_UnhealthyMachineCondition_To_v1beta2_UnhealthyMachineCondition(in, out, s)
}

func autoConvert_v1beta2_UnhealthyMachineCondition_To_v1alpha4_UnhealthyMachineCondition(in *v1beta2.UnhealthyMachineCondition, out *UnhealthyMachineCondition, s conversion.Scope) error {
	out.Type = in.Type
	out.Status = v1.ConditionStatus(in.Status)
	out.Timeout = in.Timeout
	return nil
...
// Convert_v1beta2_UnhealthyMachineCondition_To_v1alpha4_UnhealthyMachineCondition is an autogenerated conversion function.
func Convert_v1beta2_UnhealthyMachineCondition_To_v1alpha4_UnhealthyMachineCondition(in *v1beta2.UnhealthyMachineCondition, out *UnhealthyMachineCondition, s conversion.Scope) error {
	return autoConvert_v1beta2_UnhealthyMachineCondition_To_v1alpha4_UnhealthyMachineCondition(in, out, s)
}
