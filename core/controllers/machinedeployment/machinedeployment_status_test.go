...
func Test_setReplicas(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			machineSets: []*clusterv1.MachineSet{
				nil,
				fakeMachineSet("ms1", withStatusReplicas(1), withStatusV1beta2Versions(clusterv1.StatusVersion{Version: "v1.31.1", Replicas: 1})),
			},
			expectReplicas:          1,
			expectReadyReplicas:     nil,
			expectAvailableReplicas: nil,
		...
		},
		{
			...
			machineSets: []*clusterv1.MachineSet{
				fakeMachineSet("ms1", withStatusReplicas(6), withStatusV1beta2ReadyReplicas(5), withStatusV1beta2AvailableReplicas(3), withStatusV1beta2UpToDateReplicas(3), withStatusV1beta2Versions(clusterv1.StatusVersion{Version: "v1.31.1", Replicas: 4}, clusterv1.StatusVersion{Version: "v1.32.0", Replicas: 2})),
				fakeMachineSet("ms2", withStatusReplicas(3), withStatusV1beta2ReadyReplicas(2), withStatusV1beta2AvailableReplicas(2), withStatusV1beta2UpToDateReplicas(1), withStatusV1beta2Versions(clusterv1.StatusVersion{Version: "v1.32.0", Replicas: 3})),
				fakeMachineSet("ms3"),
			},
			expectReplicas:          9,
			...
			expectVersions: []clusterv1.StatusVersion{
				{Version: "v1.31.1", Replicas: 4},
				{Version: "v1.32.0", Replicas: 5},
			},
		},
	}
