...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*MachineDeploymentStrategy)(nil), (*v1beta2.MachinePoolStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_MachineDeploymentStrategy_To_v1beta2_MachinePoolStrategy(a.(*MachineDeploymentStrategy), b.(*v1beta2.MachinePoolStrategy), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*v1beta2.MachinePoolStrategy)(nil), (*MachineDeploymentStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_MachinePoolStrategy_To_v1alpha3_MachineDeploymentStrategy(a.(*v1beta2.MachinePoolStrategy), b.(*MachineDeploymentStrategy), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_MachinePoolSpec_To_v1beta2_MachinePoolSpec(in *MachinePoolSpec, out *v1beta2.MachinePoolSpec, s conversion.Scope) error {
	...
	if in.Strategy != nil {
		in, out := &in.Strategy, &out.Strategy
		*out = new(v1beta2.MachinePoolStrategy)
		if err := Convert_v1alpha3_MachineDeploymentStrategy_To_v1beta2_MachinePoolStrategy(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Strategy = nil
...
func autoConvert_v1beta2_MachinePoolSpec_To_v1alpha3_MachinePoolSpec(in *v1beta2.MachinePoolSpec, out *MachinePoolSpec, s conversion.Scope) error {
	...
	if in.Strategy != nil {
		in, out := &in.Strategy, &out.Strategy
		*out = new(MachineDeploymentStrategy)
		if err := Convert_v1beta2_MachinePoolStrategy_To_v1alpha3_MachineDeploymentStrategy(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Strategy = nil
