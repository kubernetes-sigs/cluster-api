...
func Convert_v1alpha3_MachineDeploymentStrategy_To_v1beta2_MachinePoolStrategy(in *MachineDeploymentStrategy, out *clusterv1.MachinePoolStrategy, _ apimachineryconversion.Scope) error {
	// Subfields differ in v1beta2, no conversion possible
	out.Remediation = nil
	return nil
}

func Convert_v1beta2_MachinePoolStrategy_To_v1alpha3_MachineDeploymentStrategy(in *clusterv1.MachinePoolStrategy, out *MachineDeploymentStrategy, _ apimachineryconversion.Scope) error {
	return nil
}
