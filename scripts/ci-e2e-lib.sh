...
kind:prepullAdditionalImages () {
  ...
  kind::prepullImage "quay.io/jetstack/cert-manager-cainjector:v1.15.1"
  kind::prepullImage "quay.io/jetstack/cert-manager-webhook:v1.15.1"
  kind::prepullImage "quay.io/jetstack/cert-manager-controller:v1.15.1"
}
