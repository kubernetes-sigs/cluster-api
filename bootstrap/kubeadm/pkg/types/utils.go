...
import (
	...
	"sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamhub"
...
func KubeVersionToKubeadmAPIGroupVersion(v semver.Version) (schema.GroupVersion, error) {
	...
	case version.Compare(v, v1beta4KubeadmVersion, version.WithoutPreReleases()) < 0:
		return schema.GroupVersion{}, pkgerrors.New("the bootstrap provider for kubeadm doesn't support Kubernetes version lower than v1.31.0")
	default:
