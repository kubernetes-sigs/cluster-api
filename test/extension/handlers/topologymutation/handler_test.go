	...
	}{
		{
			...
			expectedResponse: &runtimehooksv1.GeneratePatchesResponse{
				...
				Items: []runtimehooksv1.GeneratePatchesResponseItem{
					responseItem("1", `[
{"op":"add","path":"/spec/template/spec/kubeadmConfigSpec/initConfiguration","value":{"localAPIEndpoint":{},"nodeRegistration":{"kubeletExtraArgs":{"cgroup-driver":"cgroupfs"},"taints":null}}},
{"op":"add","path":"/spec/template/spec/kubeadmConfigSpec/joinConfiguration","value":{"discovery":{},"nodeRegistration":{"kubeletExtraArgs":{"cgroup-driver":"cgroupfs"},"taints":null}}},
...
{"op":"add","path":"/spec/template/spec/loadBalancer/imageRepository","value":"docker.io"}
					...
					responseItem("5", `[
{"op":"add","path":"/spec/template/spec/joinConfiguration","value":{"discovery":{},"nodeRegistration":{"kubeletExtraArgs":{"cgroup-driver":"cgroupfs"},"taints":null}}},
{"op":"add","path":"/spec/template/spec/initConfiguration","value":{"localAPIEndpoint":{},"nodeRegistration":{"kubeletExtraArgs":{"cgroup-driver":"cgroupfs"},"taints":null}}}
]`),
				},
			},
		},
