...
func (in *ClusterResourceSetBindingSpec) DeepCopyInto(out *ClusterResourceSetBindingSpec) {
	*out = *in
	if in.Bindings != nil {
		...
		*out = make(map[string]ResourcesSetBinding, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourcesSetBinding) DeepCopyInto(out *ResourcesSetBinding) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = make(map[string]ResourceBinding, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourcesSetBinding.
func (in *ResourcesSetBinding) DeepCopy() *ResourcesSetBinding {
	if in == nil {
		return nil
	}
	out := new(ResourcesSetBinding)
	in.DeepCopyInto(out)
	return out
}
