...
// OptionFunc is some configuration that modifies options for a patch request.
type OptionFunc func(*HelperOptions)

// ApplyToHelper applies this configuration to the given HelperOptions.
func (fn OptionFunc) ApplyToHelper(in *HelperOptions) {
	fn(in)
}
...
// This option should only ever be set in controller managing the object being patched.
var WithForceOverwriteConditions = func() OptionFunc {
	return func(in *HelperOptions) {
...
// on the incoming object to match metadata.generation, only if there is a change.
var WithStatusObservedGeneration = func() OptionFunc {
	return func(in *HelperOptions) {
...
// In case of conflicts for the owned conditions, the patch helper will always use the value provided by the controller.
var WithOwnedConditions = func(conditions ...clusterv1.ConditionType) OptionFunc {
	return func(in *HelperOptions) {
		in.OwnedConditions = conditions
	}
}
