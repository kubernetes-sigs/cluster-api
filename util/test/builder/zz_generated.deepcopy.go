...
import (
	...
	apiv1beta2 "sigs.k8s.io/cluster-api/exp/api/v1beta2"
)
...
func (in *ClusterClassBuilder) DeepCopyInto(out *ClusterClassBuilder) {
	*out = *in
	...
	if in.infraClusterNamingStrategy != nil {
		...
		*out = new(v1beta2.InfrastructureNamingStrategy)
		(*in).DeepCopyInto(*out)
	}
...
func (in *MachineHealthCheckBuilder) DeepCopyInto(out *MachineHealthCheckBuilder) {
	*out = *in
	...
	if in.conditions != nil {
		in, out := &in.conditions, &out.conditions
		*out = make([]v1beta2.UnhealthyCondition, len(*in))
		copy(*out, *in)
	}
...
func (in *MachinePoolBuilder) DeepCopyInto(out *MachinePoolBuilder) {
	*out = *in
	...
	if in.status != nil {
		in, out := &in.status, &out.status
		*out = new(apiv1beta2.MachinePoolStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.minReadySeconds != nil {
		in, out := &in.minReadySeconds, &out.minReadySeconds
