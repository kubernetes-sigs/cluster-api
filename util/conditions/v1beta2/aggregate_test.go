...
func TestAggregate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "One issue",
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-1", Message: "Message-1"}},  // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}}, // obj1
			},
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				...
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}}, // obj3
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
			want: &metav1.Condition{
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				...
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-B", Message: "Message-1"}}, // obj4
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Message: "Message-99"}},                     // obj5
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
			want: &metav1.Condition{
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-1", Message: "Message-1"}},  // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-2", Message: "Message-2"}},  // obj1
				...
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-3", Message: "Message-3"}},  // obj5
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}}, // obj6
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
			want: &metav1.Condition{
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-1", Message: "Message-1"}},  // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-2", Message: "Message-2"}},  // obj1
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-4", Message: "Message-4"}},  // obj2
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-5", Message: "Message-5"}},  // obj3
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-1", Message: "Message-1"}},  // obj4
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-3", Message: "Message-3"}},  // obj5
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}}, // obj6
			},
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-1", Message: "Message-1"}},   // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionFalse, Reason: "Reason-2", Message: "Message-2"}},   // obj1
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-3", Message: "Message-3"}}, // obj2
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}},  // obj3
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
		...
		},
		{
			...
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-1", Message: "Message-1"}}, // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-2", Message: "Message-2"}}, // obj1
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-4", Message: "Message-4"}}, // obj2
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-5", Message: "Message-5"}}, // obj3
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-1", Message: "Message-1"}}, // obj4
				{{Type: AvailableCondition, Status: metav1.ConditionUnknown, Reason: "Reason-3", Message: "Message-3"}}, // obj5
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-99", Message: "Message-99"}},  // obj6
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
		...
		},
		{
			name: "info messages",
			conditions: [][]metav1.Condition{
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-1", Message: "Message-1"}}, // obj0
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-2", Message: "Message-2"}}, // obj1
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-4", Message: "Message-4"}}, // obj2
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-5", Message: ""}},          // obj3
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-1", Message: "Message-1"}}, // obj4
				{{Type: AvailableCondition, Status: metav1.ConditionTrue, Reason: "Reason-3", Message: "Message-3"}}, // obj5
			},
			conditionType: AvailableCondition,
			options:       []AggregateOption{},
			want: &metav1.Condition{
