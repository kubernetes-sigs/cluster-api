...
// MachinePoolRemediationSpecInput is the input for MachinePoolRemediationSpec.
type MachinePoolRemediationSpecInput struct {
	...
	// resource configured to match the MachinePool managed Machines and be
	// configured to treat "e2e.remediation.condition" "False" as an unhealthy
	// condition with a short timeout.
	// If not specified, "mp-remediation" is used.
	Flavor *string
...
// MachinePoolRemediationSpec implements a test that verifies that Machines are remediated by MHC during unhealthy conditions.
func MachinePoolRemediationSpec(ctx context.Context, inputGetter func() MachinePoolRemediationSpecInput) {
	var (
		specName         = "mp-remediation"
		input            MachinePoolRemediationSpecInput
	...
	It("Should replace unhealthy machines", func() {
		...
		clusterctl.ApplyClusterTemplateAndWait(ctx, clusterctl.ApplyClusterTemplateAndWaitInput{
			...
			ConfigCluster: clusterctl.ConfigClusterInput{
				...
				Flavor:                   ptr.Deref(input.Flavor, "mp-remediation"),
		...
		By("Setting a machine unhealthy and wait for MachinePool remediation")
