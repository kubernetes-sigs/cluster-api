...
func (in *ClusterClassSpec) DeepCopyInto(out *ClusterClassSpec) {
	*out = *in
	...
	if in.InfrastructureNamingStrategy != nil {
		...
		*out = new(InfrastructuresNamingStrategy)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InfrastructuresNamingStrategy) DeepCopyInto(out *InfrastructuresNamingStrategy) {
	*out = *in
	if in.Template != nil {
		in, out := &in.Template, &out.Template
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InfrastructuresNamingStrategy.
func (in *InfrastructuresNamingStrategy) DeepCopy() *InfrastructuresNamingStrategy {
	if in == nil {
		return nil
	}
	out := new(InfrastructuresNamingStrategy)
