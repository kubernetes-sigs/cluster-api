...
**Note**: Only the most relevant dependencies are listed, `k8s.io/` dependencies
are kept in sync with the versions used by `sigs.k8s.io/controller-runtime`. 

- sigs.k8s.io/controller-runtime: v0.10.x => v0.10.x
- sigs.k8s.io/controller-tools: v0.7.x => v0.7.x
