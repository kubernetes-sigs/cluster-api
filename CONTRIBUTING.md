...
*   [Cluster type](https://github.com/kubernetes-sigs/cluster-api/blob/master/cluster-api/pkg/apis/cluster/v1alpha1/cluster_types.go#L40)
*   [Machine type](https://github.com/kubernetes-sigs/cluster-api/blob/master/cluster-api/pkg/apis/cluster/v1alpha1/machine_types.go#L42)
...
A sample implementation for an upgrader is [provided here](https://github.com/kubernetes-sigs/cluster-api/blob/master/cluster-api/tools/upgrader/util/upgrade.go). Each machine is upgraded serially, which can amount to:
