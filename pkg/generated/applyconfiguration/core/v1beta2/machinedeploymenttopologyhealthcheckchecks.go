...
// MachineDeploymentTopologyHealthCheckChecksApplyConfiguration represents a declarative configuration of the MachineDeploymentTopologyHealthCheckChecks type for use
// with apply.
//
...
type MachineDeploymentTopologyHealthCheckChecksApplyConfiguration struct {
...
// MachineDeploymentTopologyHealthCheckChecksApplyConfiguration constructs a declarative configuration of the MachineDeploymentTopologyHealthCheckChecks type for use with
// apply.
func MachineDeploymentTopologyHealthCheckChecks() *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration {
	return &MachineDeploymentTopologyHealthCheckChecksApplyConfiguration{}
}
...
func (b *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration) WithNodeStartupTimeoutSeconds(value int32) *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration {
...
func (b *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration) WithUnhealthyNodeConditions(values ...*UnhealthyNodeConditionApplyConfiguration) *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration) WithUnhealthyMachineConditions(values ...*UnhealthyMachineConditionApplyConfiguration) *MachineDeploymentTopologyHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
