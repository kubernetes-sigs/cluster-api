...
func Convert_v1alpha3_Bootstrap_To_v1alpha4_Bootstrap(in *Bootstrap, out *v1alpha4.Bootstrap, s apiconversion.Scope) error { //nolint
	if in.DataSecretName != nil {
		...
		out.DataSecret = &v1alpha4.DataSecret{
			ObjectReference: corev1.ObjectReference{Name: *in.DataSecretName},
...
func Convert_v1alpha4_Bootstrap_To_v1alpha3_Bootstrap(in *v1alpha4.Bootstrap, out *Bootstrap, s apiconversion.Scope) error {
	if in.DataSecret != nil {
		out.DataSecretName = &in.DataSecret.ObjectReference.Name
	}
