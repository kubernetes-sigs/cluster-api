...
type Interface interface {
	...
	AddonsV1beta2() addonsv1beta2.AddonsV1beta2Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	addonsV1beta2       *addonsv1beta2.AddonsV1beta2Client
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.addonsV1beta2, err = addonsv1beta2.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.addonsV1beta2 = addonsv1beta2.New(c)
