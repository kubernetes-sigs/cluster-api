...
func (in *ControlPlaneClass) DeepCopyInto(out *ControlPlaneClass) {
	*out = *in
	...
	in.ClusterClassTemplate.DeepCopyInto(&out.ClusterClassTemplate)
...
func (in *ExternalPatchDefinition) DeepCopyInto(out *ExternalPatchDefinition) {
	*out = *in
	if in.GeneratePatchesExtension != nil {
		in, out := &in.GeneratePatchesExtension, &out.GeneratePatchesExtension
		*out = new(string)
		**out = **in
	}
	if in.ValidateTopologyExtension != nil {
		in, out := &in.ValidateTopologyExtension, &out.ValidateTopologyExtension
		*out = new(string)
		**out = **in
	}
