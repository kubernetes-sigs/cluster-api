...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterVariablesOverrides) DeepCopyInto(out *ClusterVariablesOverrides) {
	*out = *in
	if in.Overrides != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterVariablesOverrides.
func (in *ClusterVariablesOverrides) DeepCopy() *ClusterVariablesOverrides {
	if in == nil {
		return nil
	}
	out := new(ClusterVariablesOverrides)
	in.DeepCopyInto(out)
	return out
}
