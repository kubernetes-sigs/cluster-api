...
Before starting to work on the issue, make sure that it doesn't have a [lifecycle/active](https://github.com/kubernetes-sigs/cluster-api/issues?q=is%3Aissue%20state%3Aopen%20label%3Alifecycle%2Factive) label. If the issue has been assigned, reach out to the assignee.
