...
func (src *DockerMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	err := Convert_v1alpha3_DockerMachinePool_To_v1beta1_DockerMachinePool(src, dst, nil)
	if err != nil {
		return err
	}
...
func Convert_v1beta1_DockerMachinePoolSpec_To_v1alpha3_DockerMachinePoolSpec(in *infraexpv1.DockerMachinePoolSpec, out *DockerMachinePoolSpec, s convert.Scope) error {
	return autoConvert_v1beta1_DockerMachinePoolSpec_To_v1alpha3_DockerMachinePoolSpec(in, out, s)
}

func Convert_v1alpha3_DockerMachinePoolSpec_To_v1beta1_DockerMachinePoolSpec(in *DockerMachinePoolSpec, out *infraexpv1.DockerMachinePoolSpec, s convert.Scope) error {
