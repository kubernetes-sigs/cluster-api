...
func TestKubeadmConfigTemplateDefault(t *testing.T) {
	...
	t.Run("for KubeadmConfigTemplate", testutil.CustomDefaultValidateTest[*bootstrapv1.KubeadmConfigTemplate](admission.NewContextWithRequest(ctx, admission.Request{}), updateDefaultingKubeadmConfigTemplate, webhook))
