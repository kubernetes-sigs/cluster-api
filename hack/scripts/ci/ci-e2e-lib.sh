...
# Shared helper functions sourced by ci-e2e.sh and ci-build-kind-images.sh.
...
kind:prepullAdditionalImages () {
  ...
  kind::prepullImage "quay.io/jetstack/cert-manager-cainjector:v1.21.0"
  kind::prepullImage "quay.io/jetstack/cert-manager-webhook:v1.21.0"
  kind::prepullImage "quay.io/jetstack/cert-manager-controller:v1.21.0"
