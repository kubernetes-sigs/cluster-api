...
// Convert_v1alpha4_MachinePoolStatus_To_v1beta2_MachinePoolStatus is an autogenerated conversion function.
func Convert_v1alpha4_MachinePoolStatus_To_v1beta2_MachinePoolStatus(in *MachinePoolStatus, out *v1beta2.MachinePoolStatus, s conversion.Scope) error {
	return autoConvert_v1alpha4_MachinePoolStatus_To_v1beta2_MachinePoolStatus(in, out, s)
}
