...
import (
	...
	"sigs.k8s.io/cluster-api/core/controllers/topology/cluster/patches/api"
	"sigs.k8s.io/cluster-api/core/controllers/topology/cluster/patches/external"
	"sigs.k8s.io/cluster-api/core/controllers/topology/cluster/patches/inline"
	"sigs.k8s.io/cluster-api/core/controllers/topology/cluster/patches/variables"
