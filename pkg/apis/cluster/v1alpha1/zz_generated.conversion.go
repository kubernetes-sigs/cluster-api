...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus,
		Convert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus,
	)
}
...
func autoConvert_v1alpha1_ClusterStatus_To_cluster_ClusterStatus(in *ClusterStatus, out *cluster.ClusterStatus, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus(&in.ProviderStatus, &out.ProviderStatus, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_cluster_ClusterStatus_To_v1alpha1_ClusterStatus(in *cluster.ClusterStatus, out *ClusterStatus, s conversion.Scope) error {
	...
	out.ErrorReason = common.ClusterStatusError(in.ErrorReason)
	out.ErrorMessage = in.ErrorMessage
	if err := Convert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus(&in.ProviderStatus, &out.ProviderStatus, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus(in *ProviderStatus, out *cluster.ProviderStatus, s conversion.Scope) error {
	out.Value = (*runtime.RawExtension)(unsafe.Pointer(in.Value))
	return nil
}

// Convert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus is an autogenerated conversion function.
func Convert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus(in *ProviderStatus, out *cluster.ProviderStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderStatus_To_cluster_ProviderStatus(in, out, s)
}

func autoConvert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus(in *cluster.ProviderStatus, out *ProviderStatus, s conversion.Scope) error {
	out.Value = (*runtime.RawExtension)(unsafe.Pointer(in.Value))
	return nil
}

// Convert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus is an autogenerated conversion function.
func Convert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus(in *cluster.ProviderStatus, out *ProviderStatus, s conversion.Scope) error {
	return autoConvert_cluster_ProviderStatus_To_v1alpha1_ProviderStatus(in, out, s)
}
