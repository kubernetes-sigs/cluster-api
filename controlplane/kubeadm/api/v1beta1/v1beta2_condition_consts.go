...
// KubeadmControlPlane's EtcdClusterEtcdClusterHealthy condition and corresponding reasons that will be used in v1Beta2 API version.
const (
	...
	KubeadmControlPlaneEtcdClusterInspectionFailedV1Beta2Reason = "EtcdInspectionFailed"
...
const (
	...
	KubeadmControlPlaneControlPlaneComponentsInspectionFailedV1Beta2Reason = "ControlPlaneComponentsInspectionFailed"

	// KubeadmControlPlaneControlPlaneComponentsHealthyV1Beta2Reason surfaces when the  Kubernetes control plane components
	// hosted on KubeadmControlPlane machines is healthy.
	...
	// hosted on KubeadmControlPlane machines is not healthy.
...
const (
	...
	KubeadmControlPlaneMachinePodRunningV1Beta2Reason = "PodRunning"
	...
	KubeadmControlPlaneMachinePodProvisioningV1Beta2Reason = "PodProvisioning"
	...
	// does not exist.
	KubeadmControlPlaneMachinePodDoesNotExistV1Beta2Reason = "PodDoesNotExist"
	...
	// failed during provisioning i.e., e.g CrashLoopBackOff, ImagePullBackOff or if all the containers in a pod have terminated.
	KubeadmControlPlaneMachinePodFailedV1Beta2Reason = "PodFailed"
	...
	KubeadmControlPlaneMachinePodInspectionFailedV1Beta2Reason = "PodInspectionFailed"

	// KubeadmControlPlaneMachinePodDeletingV1Beta2V1Beta2Reason surfaces when the machine hosting control plane components
	// is being deleted.
	KubeadmControlPlaneMachinePodDeletingV1Beta2V1Beta2Reason = "Deleting"
...
const (
	...
	KubeadmControlPlaneMachineEtcdMemberInspectionFailedV1Beta2Reason = "EtcdInspectionFailed"

	// KubeadmControlPlaneMachineEtcdMemberDeletingV1Beta2V1Beta2Reason surfaces when the machine hosting an etcd member
	// is being deleted.
	KubeadmControlPlaneMachineEtcdMemberDeletingV1Beta2V1Beta2Reason = "Deleting"
)
