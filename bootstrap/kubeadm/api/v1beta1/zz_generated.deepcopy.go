...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in DiskLayout) DeepCopyInto(out *DiskLayout) {
	{
		in := &in
		*out = make(DiskLayout, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskLayout.
func (in DiskLayout) DeepCopy() DiskLayout {
	if in == nil {
		return nil
	}
	out := new(DiskLayout)
...
func (in *KubeadmConfigStatus) DeepCopyInto(out *KubeadmConfigStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		...
		*out = new(KubeadmConfigV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeadmConfigV1Beta2Status) DeepCopyInto(out *KubeadmConfigV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
func (in *KubeadmConfigV1Beta2Status) DeepCopy() *KubeadmConfigV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(KubeadmConfigV1Beta2Status)
