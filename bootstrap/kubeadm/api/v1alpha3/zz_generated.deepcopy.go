...
func (in *ConfigMapFileSource) DeepCopyInto(out *ConfigMapFileSource) {
	*out = *in
	if in.FileSourceOptions != nil {
		in, out := &in.FileSourceOptions, &out.FileSourceOptions
		*out = new(FileSourceOptions)
		**out = **in
	}
	if in.Items != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileSourceOptions) DeepCopyInto(out *FileSourceOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileSourceOptions.
func (in *FileSourceOptions) DeepCopy() *FileSourceOptions {
	if in == nil {
		return nil
	}
	out := new(FileSourceOptions)
