...
runtime-test        RuntimeExtensionProvider   https://github.com/kubernetes-sigs/cluster-api/releases/latest/                             runtime-extension-components-development.yaml
...
- File: runtime-extension-components-development.yaml
  Name: runtime-test
