...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*corev1alpha4.MachineTemplateSpec)(nil), (*corev1beta2.MachineTemplateSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_MachineTemplateSpec_To_v1beta2_MachineTemplateSpec(a.(*corev1alpha4.MachineTemplateSpec), b.(*corev1beta2.MachineTemplateSpec), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*corev1beta2.MachineTemplateSpec)(nil), (*corev1alpha4.MachineTemplateSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_MachineTemplateSpec_To_v1alpha4_MachineTemplateSpec(a.(*corev1beta2.MachineTemplateSpec), b.(*corev1alpha4.MachineTemplateSpec), scope)
	}); err != nil {
		return err
	}
	return nil
