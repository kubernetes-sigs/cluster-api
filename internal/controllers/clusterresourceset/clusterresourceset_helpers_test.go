...
func TestGetorCreateClusterResourceSetBinding(t *testing.T) {
	...
	testClusterResourceSetBinding := &clusterv1.ClusterResourceSetBinding{
		ObjectMeta: metav1.ObjectMeta{
			...
			Bindings: []*clusterv1.ResourceSetBinding{
				{
					...
					Resources: []clusterv1.ResourceBinding{
						{
							ResourceRef: clusterv1.ResourceRef{
								Name: "mySecret",
								Kind: "Secret",
							},
							Applied:         true,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			clusterResourceSetBinding, err := r.getOrCreateClusterResourceSetBinding(context.TODO(), tt.cluster, &clusterv1.ClusterResourceSet{})
