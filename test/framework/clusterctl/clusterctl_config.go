...
// The main responsibility of this structure is to point clusterctl to the local repository uses for E2E tests.
type clusterctlConfig struct {
	Path   string
	Values map[string]interface{}
}

// providerConfig mirrors clusterctl config.Provider interface and allows serialization of the corresponding info into a clusterctl config file
