...
func (dst *Cluster) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_Cluster_To_v1alpha4_Cluster(src, dst, nil)
}
...
func (dst *ClusterList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_ClusterList_To_v1alpha4_ClusterList(src, dst, nil)
}
...
func (dst *Machine) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_Machine_To_v1alpha4_Machine(src, dst, nil)
}
...
func (dst *MachineList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineList_To_v1alpha4_MachineList(src, dst, nil)
}
...
func (dst *MachineSet) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineSet_To_v1alpha4_MachineSet(src, dst, nil)
}
...
func (dst *MachineSetList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineSetList_To_v1alpha4_MachineSetList(src, dst, nil)
}
...
func (dst *MachineDeployment) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineDeployment_To_v1alpha4_MachineDeployment(src, dst, nil)
}
...
func (dst *MachineDeploymentList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineDeploymentList_To_v1alpha4_MachineDeploymentList(src, dst, nil)
}
...
func (dst *MachineHealthCheck) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineHealthCheck_To_v1alpha4_MachineHealthCheck(src, dst, nil)
}
...
func (dst *MachineHealthCheckList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return autoConvert_v1beta1_MachineHealthCheckList_To_v1alpha4_MachineHealthCheckList(src, dst, nil)
}
