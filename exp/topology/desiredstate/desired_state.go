...
func (g *generator) computeMachineDeploymentVersion(ctx context.Context, s *scope.Scope, machineDeploymentTopology clusterv1.MachineDeploymentTopology, currentMDState *scope.MachineDeploymentState) (string, error) {
	...
	pinnedVersion := machineDeploymentTopology.Version
...
func pinnedMachineDeploymentNames(s *scope.Scope) sets.Set[string] {
	...
	for mdTopologyName, md := range s.Current.MachineDeployments {
		...
		if pinning.MachineDeploymentTopologyVersion(s.Blueprint.Topology, mdTopologyName) != "" {
...
func pinnedMachinePoolNames(s *scope.Scope) sets.Set[string] {
	...
	for mpTopologyName, mp := range s.Current.MachinePools {
		...
		if pinning.MachinePoolTopologyVersion(s.Blueprint.Topology, mpTopologyName) != "" {
...
func (g *generator) computeMachinePoolVersion(ctx context.Context, s *scope.Scope, machinePoolTopology clusterv1.MachinePoolTopology, currentMPState *scope.MachinePoolState) (string, error) {
	...
	pinnedVersion := machinePoolTopology.Version
