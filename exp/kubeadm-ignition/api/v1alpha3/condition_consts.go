...
// Conditions and condition Reasons for the KubeadmIgnitionConfig object
...
const (
	...
	// the KubeadmIgnitionConfig controller ensure this pre-condition is satisfied.
	...
	// DataSecretGenerationFailedReason (Severity=Warning) documents a KubeadmIgnitionConfig controller detecting
...
const (
	...
	//
	// NOTE: Cluster certificates are generated only for the KubeadmIgnitionConfig object linked to the initial control plane
	...
	// CertificatesGenerationFailedReason (Severity=Warning) documents a KubeadmIgnitionConfig controller detecting
	...
	// CertificatesCorruptedReason (Severity=Error) documents a KubeadmIgnitionConfig controller detecting
