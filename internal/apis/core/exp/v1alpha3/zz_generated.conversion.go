...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*v1beta1.MachinePoolStatus)(nil), (*MachinePoolStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*apiv1beta1.MachineTemplateSpec)(nil), (*corev1alpha3.MachineTemplateSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_MachineTemplateSpec_To_v1alpha3_MachineTemplateSpec(a.(*apiv1beta1.MachineTemplateSpec), b.(*corev1alpha3.MachineTemplateSpec), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha3_MachinePoolSpec_To_v1beta1_MachinePoolSpec(in *MachinePoolSpec, out *v1beta1.MachinePoolSpec, s conversion.Scope) error {
	...
	if in.Strategy != nil {
		...
		*out = new(v1beta1.MachinePoolStrategy)
		// FIXME: Provide conversion function to convert corev1alpha3.MachineDeploymentStrategy to v1beta1.MachinePoolStrategy
...
func autoConvert_v1beta1_MachinePoolSpec_To_v1alpha3_MachinePoolSpec(in *v1beta1.MachinePoolSpec, out *MachinePoolSpec, s conversion.Scope) error {
	...
	if in.Strategy != nil {
		...
		*out = new(corev1alpha3.MachineDeploymentStrategy)
		// FIXME: Provide conversion function to convert v1beta1.MachinePoolStrategy to corev1alpha3.MachineDeploymentStrategy
		compileErrorOnMissingConversion()
	} else {
		out.Strategy = nil
	}
