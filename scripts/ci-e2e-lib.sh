...
kind:prepullAdditionalImages () {
  ...
  kind::prepullImage "quay.io/jetstack/cert-manager-cainjector:v1.12.3"
  kind::prepullImage "quay.io/jetstack/cert-manager-webhook:v1.12.3"
  kind::prepullImage "quay.io/jetstack/cert-manager-controller:v1.12.3"
}
