...
func (webhook *KubeadmControlPlane) ValidateCreate(_ context.Context, k *controlplanev1.KubeadmControlPlane) (admission.Warnings, error) {
	...
	allErrs = append(allErrs, kubeadmbootstrapwebhooks.Validate(&spec.KubeadmConfigSpec, true, field.NewPath("spec", "kubeadmConfigSpec"))...)
	if len(allErrs) > 0 {
...
func (webhook *KubeadmControlPlane) ValidateUpdate(_ context.Context, oldK, newK *controlplanev1.KubeadmControlPlane) (admission.Warnings, error) {
	...
	allErrs = append(allErrs, kubeadmbootstrapwebhooks.Validate(&newK.Spec.KubeadmConfigSpec, true, field.NewPath("spec", "kubeadmConfigSpec"))...)
