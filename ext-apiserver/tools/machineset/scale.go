...
import (
	...
	clientv1alpha1 "k8s.io/kube-deploy/ext-apiserver/pkg/client/clientset_generated/clientset/typed/cluster/v1alpha1"
)
...
func scale(machines clientv1alpha1.MachineInterface, labelSelector string, replicas int) error {
...
func clone(old clusterv1alpha1.Machine) *clusterv1alpha1.Machine {
	...
	newMachine.Status = clusterv1alpha1.MachineStatus{}
	return newMachine
}
