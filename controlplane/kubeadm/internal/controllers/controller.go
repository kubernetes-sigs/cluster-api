...
func (r *KubeadmControlPlaneReconciler) syncMachines(ctx context.Context, controlPlane *internal.ControlPlane) error {
	...
	for machineName := range controlPlane.Machines {
		...
		if !m.DeletionTimestamp.IsZero() {
			...
			m.Spec.Deletion.NodeDrainTimeoutSeconds = controlPlane.KCP.Spec.MachineTemplate.Deletion.NodeDrainTimeoutSeconds
			m.Spec.Deletion.NodeDeletionTimeoutSeconds = controlPlane.KCP.Spec.MachineTemplate.Deletion.NodeDeletionTimeoutSeconds
			m.Spec.Deletion.NodeVolumeDetachTimeoutSeconds = controlPlane.KCP.Spec.MachineTemplate.Deletion.NodeVolumeDetachTimeoutSeconds
