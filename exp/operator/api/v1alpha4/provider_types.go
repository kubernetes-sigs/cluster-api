...
import (
	...
	runtimeconfigv1 "sigs.k8s.io/controller-runtime/pkg/config/v1alpha1"
)
...
type ManagerSpec struct {
	...
	runtimeconfigv1.ControllerManagerConfigurationSpec `json:",inline"`
	...
	// Debug will override a set of fields with opinionated values for
...
type FetchConfiguration struct {
	// URL to be used for fetching the providers components and metadata from a remote Github repository.
