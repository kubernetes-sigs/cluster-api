...
// AllKnownTypes returns all known types.
func (c *Catalog) AllKnownTypes() map[schema.GroupVersionKind]reflect.Type {
	return c.scheme.AllKnownTypes()
}

// AllKnownHooks returns all known hooks.
func (c *Catalog) AllKnownHooks() map[GroupVersionHook]HookDescriptor {
	return c.gvhToHookDescriptor
}
