...
func Convert_v1beta2_Condition_To_v1_Condition(in *clusterv1.Condition, out *metav1.Condition, s apiconversion.Scope) error {
	return nil
}

func Convert_v1_Condition_To_v1beta2_Condition(in *metav1.Condition, out *clusterv1.Condition, s apiconversion.Scope) error {
	return nil
}
