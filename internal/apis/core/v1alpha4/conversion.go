...
func (src *Cluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	if src.Status.Conditions != nil || src.Status.FailureReason != nil || src.Status.FailureMessage != nil {
		...
		if src.Status.Conditions != nil {
			Convert_Deprecated_v1alpha4_Conditions_To_v1beta2_Conditions(&src.Status.Conditions, &dst.Status.Deprecated.V1Beta1.Conditions)
		}
	...
	if src.Status.Deprecated != nil {
		if src.Status.Deprecated.V1Beta1 != nil {
			if src.Status.Deprecated.V1Beta1.Conditions != nil {
				Convert_v1beta2_Conditions_To_Deprecated_v1alpha4_Conditions(&src.Status.Deprecated.V1Beta1.Conditions, &dst.Status.Conditions)
			}
...
func Convert_v1beta2_Conditions_To_Deprecated_v1alpha4_Conditions(in *clusterv1.Conditions, out *Conditions) {
...
func Convert_Deprecated_v1alpha4_Conditions_To_v1beta2_Conditions(in *Conditions, out *clusterv1.Conditions) {
