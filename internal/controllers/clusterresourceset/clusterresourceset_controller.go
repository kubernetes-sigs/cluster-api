...
func (r *ClusterResourceSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, options controller.Options, partialSecretCache cache.Cache) error {
	...
	err := ctrl.NewControllerManagedBy(mgr).
		For(&clusterv1.ClusterResourceSet{}).
		Watches(
			&clusterv1.Cluster{},
...
func (r *ClusterResourceSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	if finalizerAdded, err := finalizers.EnsureFinalizer(ctx, r.Client, clusterResourceSet, clusterv1.ClusterResourceSetFinalizer); err != nil || finalizerAdded {
		return ctrl.Result{}, err
	}
	...
	if err != nil {
		...
		conditions.MarkFalse(clusterResourceSet, clusterv1.ResourcesAppliedCondition, clusterv1.ClusterMatchFailedReason, clusterv1.ConditionSeverityWarning, err.Error())
		v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
			Type:    clusterv1.ResourcesAppliedV1Beta2Condition,
			Status:  metav1.ConditionFalse,
			Reason:  clusterv1.ResourcesAppliedInternalErrorV1Beta2Reason,
...
func (r *ClusterResourceSetReconciler) reconcileDelete(ctx context.Context, clusters []*clusterv1.Cluster, crs *clusterv1.ClusterResourceSet) error {
	for _, cluster := range clusters {
		log := ctrl.LoggerFrom(ctx, "Cluster", klog.KObj(cluster))

		clusterResourceSetBinding := &clusterv1.ClusterResourceSetBinding{}
		...
		if err := r.Client.Get(ctx, clusterResourceSetBindingKey, clusterResourceSetBinding); err != nil {
			...
			controllerutil.RemoveFinalizer(crs, clusterv1.ClusterResourceSetFinalizer)
			return nil
		}
...
func (r *ClusterResourceSetReconciler) getClustersByClusterResourceSetSelector(ctx context.Context, clusterResourceSet *clusterv1.ClusterResourceSet) ([]*clusterv1.Cluster, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *ClusterResourceSetReconciler) ApplyClusterResourceSet(ctx context.Context, cluster *clusterv1.Cluster, clusterResourceSet *clusterv1.ClusterResourceSet) (rerr error) {
	log := ctrl.LoggerFrom(ctx, "Cluster", klog.KObj(cluster))
	...
	for i, resource := range clusterResourceSet.Spec.Resources {
		...
		if err != nil {
			if err == ErrSecretTypeNotSupported {
				conditions.MarkFalse(clusterResourceSet, clusterv1.ResourcesAppliedCondition, clusterv1.WrongSecretTypeReason, clusterv1.ConditionSeverityWarning, err.Error())
				v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
					Type:    clusterv1.ResourcesAppliedV1Beta2Condition,
					Status:  metav1.ConditionFalse,
					Reason:  clusterv1.ResourcesAppliedWrongSecretTypeV1Beta2Reason,
					Message: fmt.Sprintf("Secret type of resource %s is not supported", resource.Name),
				})
			} else {
				conditions.MarkFalse(clusterResourceSet, clusterv1.ResourcesAppliedCondition, clusterv1.RetrievingResourceFailedReason, clusterv1.ConditionSeverityWarning, err.Error())
				v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
					Type:    clusterv1.ResourcesAppliedV1Beta2Condition,
					Status:  metav1.ConditionFalse,
					Reason:  clusterv1.ResourcesAppliedInternalErrorV1Beta2Reason,
	...
	if err != nil {
		conditions.MarkFalse(clusterResourceSet, clusterv1.ResourcesAppliedCondition, clusterv1.RemoteClusterClientFailedReason, clusterv1.ConditionSeverityError, err.Error())
		v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
			Type:    clusterv1.ResourcesAppliedV1Beta2Condition,
			Status:  metav1.ConditionFalse,
	...
	for i, resource := range clusterResourceSet.Spec.Resources {
		...
		if err != nil {
			resourceSetBinding.SetBinding(clusterv1.ResourceBinding{
		...
		if err := resourceScope.apply(ctx, remoteClient); err != nil {
			...
			conditions.MarkFalse(clusterResourceSet, clusterv1.ResourcesAppliedCondition, clusterv1.ApplyFailedReason, clusterv1.ConditionSeverityWarning, err.Error())
			v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
				Type:    clusterv1.ResourcesAppliedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
				Reason:  clusterv1.ResourcesNotAppliedV1Beta2Reason,
	...
	conditions.MarkTrue(clusterResourceSet, clusterv1.ResourcesAppliedCondition)
	v1beta2conditions.Set(clusterResourceSet, metav1.Condition{
		Type:   clusterv1.ResourcesAppliedV1Beta2Condition,
		Status: metav1.ConditionTrue,
		Reason: clusterv1.ResourcesAppliedV1beta2Reason,
	})
...
func (r *ClusterResourceSetReconciler) getResource(ctx context.Context, resourceRef clusterv1.ResourceRef, namespace string) (*unstructured.Unstructured, error) {
	...
	case string(clusterv1.SecretClusterResourceSetResourceKind):
		...
		if resourceSecret.Type != clusterv1.ClusterResourceSetSecretType {
...
func (r *ClusterResourceSetReconciler) ensureResourceOwnerRef(ctx context.Context, clusterResourceSet *clusterv1.ClusterResourceSet, resource *unstructured.Unstructured) error {
...
func (r *ClusterResourceSetReconciler) clusterToClusterResourceSet(ctx context.Context, o client.Object) []ctrl.Request {
	...
	resourceList := &clusterv1.ClusterResourceSetList{}
