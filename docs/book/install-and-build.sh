...
echo "downloading mdBook-${version}-${arch}-${target}.${ext}"
set -x
curl -sL -o /tmp/mdbook.${ext} "https://github.com/rust-lang-nursery/mdBook/releases/download/${version}/mdBook-${version}-${arch}-${target}.${ext}"
${cmd} /tmp/mdbook.${ext}
chmod +x /tmp/mdbook
