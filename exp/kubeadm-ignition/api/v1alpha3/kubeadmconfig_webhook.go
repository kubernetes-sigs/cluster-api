...
func (c *KubeadmIgnitionConfig) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
func (c *KubeadmIgnitionConfig) ValidateCreate() error {
	return c.Spec.validate(c.Name)
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (c *KubeadmIgnitionConfig) ValidateUpdate(old runtime.Object) error {
	return c.Spec.validate(c.Name)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (c *KubeadmIgnitionConfig) ValidateDelete() error {
	return nil
}

func (c *KubeadmIgnitionConfigSpec) validate(name string) error {
	...
	return apierrors.NewInvalid(GroupVersion.WithKind("KubeadmIgnitionConfig").GroupKind(), name, allErrs)
}
