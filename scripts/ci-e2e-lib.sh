...
kind:prepullAdditionalImages () {
  ...
  kind::prepullImage "quay.io/jetstack/cert-manager-cainjector:v1.18.2"
  kind::prepullImage "quay.io/jetstack/cert-manager-webhook:v1.18.2"
  kind::prepullImage "quay.io/jetstack/cert-manager-controller:v1.18.2"
