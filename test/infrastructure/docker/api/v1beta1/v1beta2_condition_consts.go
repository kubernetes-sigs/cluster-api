...
const (
	// DockerClusterReadyV1Beta2Condition is true if the ClusterClass is not deleted,
	...
	// DockerClusterDeletingV1Beta2Condition surfaces details about ongoing deletion of the controlled machines.
...
const (
	// DockerMachineReadyV1Beta2Condition is true if the ClusterClass is not deleted,
	...
	// DockerMachineDeletingV1Beta2Condition surfaces details about ongoing deletion of the controlled machines.
