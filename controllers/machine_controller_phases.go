...
func (r *MachineReconciler) reconcileExternal(ctx context.Context, cluster *clusterv1.Cluster, m *clusterv1.Machine, ref *clusterv1.LocalObjectReference) (external.ReconcileOutput, error) {
