...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeconfigSpec)(nil), (*v1beta2.KubeconfigSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_KubeconfigSpec_To_v1beta2_KubeconfigSpec(a.(*KubeconfigSpec), b.(*v1beta2.KubeconfigSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.KubeconfigSpec)(nil), (*KubeconfigSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_KubeconfigSpec_To_v1beta1_KubeconfigSpec(a.(*v1beta2.KubeconfigSpec), b.(*KubeconfigSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ClusterSpec_To_v1beta2_ClusterSpec(in *ClusterSpec, out *v1beta2.ClusterSpec, s conversion.Scope) error {
	...
	out.AvailabilityGates = *(*[]v1beta2.ClusterAvailabilityGate)(unsafe.Pointer(&in.AvailabilityGates))
	// WARNING: in.Kubeconfig requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/api/core/v1beta1.KubeconfigSpec vs sigs.k8s.io/cluster-api/api/core/v1beta2.KubeconfigSpec)
	return nil
}
...
func autoConvert_v1beta2_ClusterSpec_To_v1beta1_ClusterSpec(in *v1beta2.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	out.AvailabilityGates = *(*[]ClusterAvailabilityGate)(unsafe.Pointer(&in.AvailabilityGates))
	// WARNING: in.Kubeconfig requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/core/v1beta2.KubeconfigSpec vs *sigs.k8s.io/cluster-api/api/core/v1beta1.KubeconfigSpec)
	return nil
}
...
func autoConvert_v1beta1_KubeconfigSpec_To_v1beta2_KubeconfigSpec(in *KubeconfigSpec, out *v1beta2.KubeconfigSpec, s conversion.Scope) error {
	if err := Convert_v1beta1_ObjectMeta_To_v1beta2_ObjectMeta(&in.Metadata, &out.Metadata, s); err != nil {
		return err
	}
	return nil
...
// Convert_v1beta1_KubeconfigSpec_To_v1beta2_KubeconfigSpec is an autogenerated conversion function.
func Convert_v1beta1_KubeconfigSpec_To_v1beta2_KubeconfigSpec(in *KubeconfigSpec, out *v1beta2.KubeconfigSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_KubeconfigSpec_To_v1beta2_KubeconfigSpec(in, out, s)
}

func autoConvert_v1beta2_KubeconfigSpec_To_v1beta1_KubeconfigSpec(in *v1beta2.KubeconfigSpec, out *KubeconfigSpec, s conversion.Scope) error {
	if err := Convert_v1beta2_ObjectMeta_To_v1beta1_ObjectMeta(&in.Metadata, &out.Metadata, s); err != nil {
		return err
	}
	return nil
...
// Convert_v1beta2_KubeconfigSpec_To_v1beta1_KubeconfigSpec is an autogenerated conversion function.
func Convert_v1beta2_KubeconfigSpec_To_v1beta1_KubeconfigSpec(in *v1beta2.KubeconfigSpec, out *KubeconfigSpec, s conversion.Scope) error {
	return autoConvert_v1beta2_KubeconfigSpec_To_v1beta1_KubeconfigSpec(in, out, s)
}
