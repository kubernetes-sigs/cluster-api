...
type DockerClusterStatus struct {
	...
	// +Metrics:gauge:name="status_condition_last_transition_time",help="The condition's last transition time of a dockercluster.",valueFrom=.lastTransitionTime,labelsFromPath={"type":".type","status":".status"}
