...
This information must be represented as a field with name `nodeInfo`, pointer to a struct with two optional subfields, 
...
metadata:
  annotations:
    capacity.cluster-autoscaler.kubernetes.io/labels: kuberenetes.io/arch=amd64
---
