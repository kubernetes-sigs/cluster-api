...
func (r *Reconciler) updateV1Beta1Status(ctx context.Context, controlPlane *pkg.ControlPlane) error {
...
func (r *Reconciler) updateStatus(ctx context.Context, controlPlane *pkg.ControlPlane) error {
...
func setScalingUpCondition(_ context.Context, cluster *clusterv1.Cluster, kcp *controlplanev1.KubeadmControlPlane, machines collections.Machines, infrastructureObjectNotFound bool, preflightChecks pkg.PreflightCheckResults) {
...
func setScalingDownCondition(_ context.Context, cluster *clusterv1.Cluster, kcp *controlplanev1.KubeadmControlPlane, machines collections.Machines, preflightChecks pkg.PreflightCheckResults) {
	if kcp.Spec.Replicas == nil {
		conditions.Set(kcp, metav1.Condition{
...
func setLastRemediation(_ context.Context, controlPlane *pkg.ControlPlane) error {
...
func getPreflightMessages(cluster *clusterv1.Cluster, preflightChecks pkg.PreflightCheckResults) []string {
