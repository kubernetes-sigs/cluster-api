...
generate-e2e-templates-main: $(KUSTOMIZE)
	...
	$(KUSTOMIZE) build $(DOCKER_TEMPLATES)/main/cluster-template-etcd-defrag --load-restrictor LoadRestrictionsNone > $(DOCKER_TEMPLATES)/main/cluster-template-etcd-defrag.yaml
