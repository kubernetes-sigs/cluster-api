...
func (in *ClusterBuilder) DeepCopyInto(out *ClusterBuilder) {
	*out = *in
	...
	if in.statusFailureDomains != nil {
		in, out := &in.statusFailureDomains, &out.statusFailureDomains
...
func (in *ClusterClassBuilder) DeepCopyInto(out *ClusterClassBuilder) {
	*out = *in
	...
	if in.controlPlaneNaming != nil {
		in, out := &in.controlPlaneNaming, &out.controlPlaneNaming
		*out = new(v1beta2.ControlPlaneClassNamingSpec)
		**out = **in
	}
	if in.infraClusterNaming != nil {
		in, out := &in.infraClusterNaming, &out.infraClusterNaming
		*out = new(v1beta2.InfrastructureClassNamingSpec)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InfrastructureMachineBuilder) DeepCopyInto(out *InfrastructureMachineBuilder) {
	*out = *in
	if in.obj != nil {
		in, out := &in.obj, &out.obj
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InfrastructureMachineBuilder.
func (in *InfrastructureMachineBuilder) DeepCopy() *InfrastructureMachineBuilder {
	if in == nil {
		return nil
	}
	out := new(InfrastructureMachineBuilder)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MachineDeploymentBuilder) DeepCopyInto(out *MachineDeploymentBuilder) {
	*out = *in
	...
	if in.status != nil {
		...
		*out = new(v1beta2.MachineDeploymentStatus)
		(*in).DeepCopyInto(*out)
	}
...
func (in *MachinePoolBuilder) DeepCopyInto(out *MachinePoolBuilder) {
	*out = *in
	...
	if in.status != nil {
		in, out := &in.status, &out.status
		*out = new(v1beta2.MachinePoolStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.minReadySeconds != nil {
		in, out := &in.minReadySeconds, &out.minReadySeconds
...
func (in *MachinePoolClassBuilder) DeepCopyInto(out *MachinePoolClassBuilder) {
	*out = *in
	...
	if in.naming != nil {
		in, out := &in.naming, &out.naming
		*out = new(v1beta2.MachinePoolClassNamingSpec)
		**out = **in
	}
}
