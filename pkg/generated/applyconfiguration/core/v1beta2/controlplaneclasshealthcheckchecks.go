...
// ControlPlaneClassHealthCheckChecksApplyConfiguration represents a declarative configuration of the ControlPlaneClassHealthCheckChecks type for use
// with apply.
//
// ControlPlaneClassHealthCheckChecks are the checks that are used to evaluate if a control plane Machine is healthy.
type ControlPlaneClassHealthCheckChecksApplyConfiguration struct {
...
// ControlPlaneClassHealthCheckChecksApplyConfiguration constructs a declarative configuration of the ControlPlaneClassHealthCheckChecks type for use with
// apply.
func ControlPlaneClassHealthCheckChecks() *ControlPlaneClassHealthCheckChecksApplyConfiguration {
	return &ControlPlaneClassHealthCheckChecksApplyConfiguration{}
}
...
func (b *ControlPlaneClassHealthCheckChecksApplyConfiguration) WithNodeStartupTimeoutSeconds(value int32) *ControlPlaneClassHealthCheckChecksApplyConfiguration {
...
func (b *ControlPlaneClassHealthCheckChecksApplyConfiguration) WithUnhealthyNodeConditions(values ...*UnhealthyNodeConditionApplyConfiguration) *ControlPlaneClassHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *ControlPlaneClassHealthCheckChecksApplyConfiguration) WithUnhealthyMachineConditions(values ...*UnhealthyMachineConditionApplyConfiguration) *ControlPlaneClassHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
