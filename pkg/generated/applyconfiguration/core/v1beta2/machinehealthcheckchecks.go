...
// MachineHealthCheckChecksApplyConfiguration represents a declarative configuration of the MachineHealthCheckChecks type for use
// with apply.
//
// MachineHealthCheckChecks are the checks that are used to evaluate if a Machine is healthy.
type MachineHealthCheckChecksApplyConfiguration struct {
...
// MachineHealthCheckChecksApplyConfiguration constructs a declarative configuration of the MachineHealthCheckChecks type for use with
// apply.
func MachineHealthCheckChecks() *MachineHealthCheckChecksApplyConfiguration {
	return &MachineHealthCheckChecksApplyConfiguration{}
}
...
func (b *MachineHealthCheckChecksApplyConfiguration) WithNodeStartupTimeoutSeconds(value int32) *MachineHealthCheckChecksApplyConfiguration {
...
func (b *MachineHealthCheckChecksApplyConfiguration) WithUnhealthyNodeConditions(values ...*UnhealthyNodeConditionApplyConfiguration) *MachineHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *MachineHealthCheckChecksApplyConfiguration) WithUnhealthyMachineConditions(values ...*UnhealthyMachineConditionApplyConfiguration) *MachineHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
