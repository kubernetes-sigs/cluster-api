...
func autoConvert_upstreamv1beta3_BootstrapToken_To_v1beta2_BootstrapToken(in *BootstrapToken, out *v1beta2.BootstrapToken, s conversion.Scope) error {
	// WARNING: in.Token requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.BootstrapTokenString vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.BootstrapTokenString)
...
func autoConvert_v1beta2_BootstrapToken_To_upstreamv1beta3_BootstrapToken(in *v1beta2.BootstrapToken, out *BootstrapToken, s conversion.Scope) error {
	// WARNING: in.Token requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.BootstrapTokenString vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.BootstrapTokenString)
	out.Description = in.Description
...
func autoConvert_upstreamv1beta3_Discovery_To_v1beta2_Discovery(in *Discovery, out *v1beta2.Discovery, s conversion.Scope) error {
	// WARNING: in.BootstrapToken requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.BootstrapTokenDiscovery vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.BootstrapTokenDiscovery)
	// WARNING: in.File requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.FileDiscovery vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.FileDiscovery)
...
func autoConvert_v1beta2_Discovery_To_upstreamv1beta3_Discovery(in *v1beta2.Discovery, out *Discovery, s conversion.Scope) error {
	// WARNING: in.BootstrapToken requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.BootstrapTokenDiscovery vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.BootstrapTokenDiscovery)
	// WARNING: in.File requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.FileDiscovery vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.FileDiscovery)
	out.TLSBootstrapToken = in.TLSBootstrapToken
	return nil
}

func autoConvert_upstreamv1beta3_Etcd_To_v1beta2_Etcd(in *Etcd, out *v1beta2.Etcd, s conversion.Scope) error {
	// WARNING: in.Local requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.LocalEtcd vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.LocalEtcd)
	// WARNING: in.External requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.ExternalEtcd vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.ExternalEtcd)
	return nil
}

func autoConvert_v1beta2_Etcd_To_upstreamv1beta3_Etcd(in *v1beta2.Etcd, out *Etcd, s conversion.Scope) error {
	// WARNING: in.Local requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.LocalEtcd vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.LocalEtcd)
	// WARNING: in.External requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.ExternalEtcd vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.ExternalEtcd)
	return nil
}
...
func autoConvert_upstreamv1beta3_InitConfiguration_To_v1beta2_InitConfiguration(in *InitConfiguration, out *v1beta2.InitConfiguration, s conversion.Scope) error {
	...
	// WARNING: in.Patches requires manual conversion: inconvertible types (*sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.Patches vs sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.Patches)
	return nil
}
...
func autoConvert_v1beta2_InitConfiguration_To_upstreamv1beta3_InitConfiguration(in *v1beta2.InitConfiguration, out *InitConfiguration, s conversion.Scope) error {
	...
	out.SkipPhases = *(*[]string)(unsafe.Pointer(&in.SkipPhases))
	// WARNING: in.Patches requires manual conversion: inconvertible types (sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2.Patches vs *sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/types/upstreamv1beta3.Patches)
