...
var clustersResource = schema.GroupVersionResource{Group: "cluster.sigs.k8s.io", Version: "v1alpha2", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cluster.sigs.k8s.io", Version: "v1alpha2", Kind: "Cluster"}
...
func (c *FakeClusters) UpdateStatus(cluster *v1alpha2.Cluster) (*v1alpha2.Cluster, error) {
	obj, err := c.Fake.
