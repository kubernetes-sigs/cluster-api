...
func (in *CanUpdateMachineRequest) DeepCopyInto(out *CanUpdateMachineRequest) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.CommonRequest.DeepCopyInto(&out.CommonRequest)
	in.CurrentMachineObjects.DeepCopyInto(&out.CurrentMachineObjects)
	in.DesiredMachineObjects.DeepCopyInto(&out.DesiredMachineObjects)
}
...
func (in *CanUpdateMachineResponse) DeepCopyInto(out *CanUpdateMachineResponse) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.CommonResponse = in.CommonResponse
	if in.MachinePatches != nil {
		in, out := &in.MachinePatches, &out.MachinePatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.InfrastructureMachinePatches != nil {
		in, out := &in.InfrastructureMachinePatches, &out.InfrastructureMachinePatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.BootstrapConfigPatches != nil {
		in, out := &in.BootstrapConfigPatches, &out.BootstrapConfigPatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *CanUpdateMachineSetRequest) DeepCopyInto(out *CanUpdateMachineSetRequest) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.CommonRequest.DeepCopyInto(&out.CommonRequest)
	in.CurrentUpdateMachineSetObjects.DeepCopyInto(&out.CurrentUpdateMachineSetObjects)
	in.DesiredUpdateMachineSetObjects.DeepCopyInto(&out.DesiredUpdateMachineSetObjects)
}
...
func (in *CanUpdateMachineSetResponse) DeepCopyInto(out *CanUpdateMachineSetResponse) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.CommonResponse = in.CommonResponse
	if in.MachineSetPatches != nil {
		in, out := &in.MachineSetPatches, &out.MachineSetPatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.InfrastructureMachineTemplateSpecPatches != nil {
		in, out := &in.InfrastructureMachineTemplateSpecPatches, &out.InfrastructureMachineTemplateSpecPatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.BootstrapConfigTemplateSpecPatches != nil {
		in, out := &in.BootstrapConfigTemplateSpecPatches, &out.BootstrapConfigTemplateSpecPatches
		*out = make([]PatchItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpdateMachineObjects) DeepCopyInto(out *UpdateMachineObjects) {
	*out = *in
	in.MachineSpec.DeepCopyInto(&out.MachineSpec)
	in.InfrastructureMachineSpec.DeepCopyInto(&out.InfrastructureMachineSpec)
	if in.BootstrapConfigSpec != nil {
		in, out := &in.BootstrapConfigSpec, &out.BootstrapConfigSpec
		*out = new(runtime.RawExtension)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpdateMachineObjects.
func (in *UpdateMachineObjects) DeepCopy() *UpdateMachineObjects {
	if in == nil {
		return nil
	}
	out := new(UpdateMachineObjects)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpdateMachineRequest) DeepCopyInto(out *UpdateMachineRequest) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.CommonRequest.DeepCopyInto(&out.CommonRequest)
	in.DesiredUpdateMachineObjects.DeepCopyInto(&out.DesiredUpdateMachineObjects)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpdateMachineSetObjects) DeepCopyInto(out *UpdateMachineSetObjects) {
	*out = *in
	in.MachineSetSpec.DeepCopyInto(&out.MachineSetSpec)
	in.InfrastructureMachineTemplateSpec.DeepCopyInto(&out.InfrastructureMachineTemplateSpec)
	if in.BootstrapConfigTemplateSpec != nil {
		in, out := &in.BootstrapConfigTemplateSpec, &out.BootstrapConfigTemplateSpec
		*out = new(runtime.RawExtension)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpdateMachineSetObjects.
func (in *UpdateMachineSetObjects) DeepCopy() *UpdateMachineSetObjects {
	if in == nil {
		return nil
	}
	out := new(UpdateMachineSetObjects)
	in.DeepCopyInto(out)
	return out
}
