...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachinePoolStrategy.
func (in *MachinePoolStrategy) DeepCopy() *MachinePoolStrategy {
	if in == nil {
		return nil
	}
	out := new(MachinePoolStrategy)
