...
func (r *Reconciler) reconcileSetOwnerAndLabels(_ context.Context, s *scope) (ctrl.Result, error) {
	cluster := s.cluster
	mp := s.machinePool
...
func (r *Reconciler) isMachinePoolNodeDeleteTimeoutPassed(machinePool *clusterv1.MachinePool) bool {
...
func (r *Reconciler) getMachinesForMachinePool(ctx context.Context, s *scope) (ctrl.Result, error) {
...
func (r *Reconciler) setMachinesUptoDate(ctx context.Context, s *scope) (ctrl.Result, error) {
	var errs []error
