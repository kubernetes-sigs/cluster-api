...
// +kubebuilder:printcolumn:name="W to date",type=integer,JSONPath=".status.workers.upToDateReplicas",description="The number of worker machines with UpToDate condition true"
