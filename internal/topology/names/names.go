...
// MachineSettMachineNameGenerator returns a generator for creating a machineSet machine name.
func MachineSettMachineNameGenerator(templateString, clusterName, machineSetName string) NameGenerator {
	return newTemplateGenerator(templateString, clusterName,
		map[string]interface{}{
