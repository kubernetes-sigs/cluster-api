...
generate-e2e-templates-main: $(KUSTOMIZE)
	...
	$(KUSTOMIZE) build $(DOCKER_TEMPLATES)/main/cluster-template-topology-worker-version-pinning --load-restrictor LoadRestrictionsNone > $(DOCKER_TEMPLATES)/main/cluster-template-topology-worker-version-pinning.yaml
