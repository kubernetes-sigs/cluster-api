...
func schema_api_runtime_hooks_v1alpha1_UpdateMachineResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UpdateMachineResponse is the response of the UpdateMachine hook.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"updateStatus": {
						SchemaProps: spec.SchemaProps{
							Description: "updateStatus indicates the current status of the update operation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"status", "retryAfterSeconds", "updateStatus"},
			},
		},
	}
}
