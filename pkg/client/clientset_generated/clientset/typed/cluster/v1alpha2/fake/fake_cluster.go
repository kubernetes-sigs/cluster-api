...
var clustersResource = schema.GroupVersionResource{Group: "cluster.x-k8s.io", Version: "v1alpha2", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cluster.x-k8s.io", Version: "v1alpha2", Kind: "Cluster"}
