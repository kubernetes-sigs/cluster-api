...
func (in *ExtensionConfigDeprecatedStatus) DeepCopyInto(out *ExtensionConfigDeprecatedStatus) {
	*out = *in
	if in.V1Alpha1 != nil {
		in, out := &in.V1Alpha1, &out.V1Alpha1
		*out = new(ExtensionConfigV1Alpha1DeprecatedStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionConfigV1Alpha1DeprecatedStatus) DeepCopyInto(out *ExtensionConfigV1Alpha1DeprecatedStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionConfigV1Alpha1DeprecatedStatus.
func (in *ExtensionConfigV1Alpha1DeprecatedStatus) DeepCopy() *ExtensionConfigV1Alpha1DeprecatedStatus {
	if in == nil {
		return nil
	}
	out := new(ExtensionConfigV1Alpha1DeprecatedStatus)
