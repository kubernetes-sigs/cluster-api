...
type rolloutSequenceTestCase struct {
	...
	// 		return false
	// 	},
	minAvailableBreachToleration func(log *fileLogger, i int, scope *rolloutScope, minAvailableReplicas, totAvailableReplicas int32) bool
...
func (l *fileLogger) NewTestCase(name, fileName string) {
	if l.testCase != "" {
