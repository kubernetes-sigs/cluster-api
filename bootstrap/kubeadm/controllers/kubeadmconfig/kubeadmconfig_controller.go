...
import (
	...
	"sigs.k8s.io/cluster-api/bootstrap/kubeadm/pkg/ignition"
...
// Reconciler reconciles a KubeadmConfig object.
...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (retRes ctrl.Result, rerr error) {
	...
	configOwner, err := GetTypedConfigOwner(ctx, r.Client, config)
	if err != nil {
		if apierrors.IsNotFound(err) {
...
func (r *Reconciler) reconcile(ctx context.Context, scope *Scope, cluster *clusterv1.Cluster, config *bootstrapv1.KubeadmConfig, configOwner *ConfigOwner) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) refreshBootstrapTokenIfNeeded(ctx context.Context, config *bootstrapv1.KubeadmConfig, cluster *clusterv1.Cluster, scope *Scope) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) recreateBootstrapToken(ctx context.Context, config *bootstrapv1.KubeadmConfig, scope *Scope, remoteClient client.Client) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) rotateMachinePoolBootstrapToken(ctx context.Context, config *bootstrapv1.KubeadmConfig, cluster *clusterv1.Cluster, scope *Scope) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) handleClusterNotInitialized(ctx context.Context, scope *Scope) (_ ctrl.Result, reterr error) {
...
func (r *Reconciler) joinWorker(ctx context.Context, scope *Scope) (ctrl.Result, error) {
...
func (r *Reconciler) getControlPlaneVersion(ctx context.Context, cluster *clusterv1.Cluster) (string, error) {
...
func (r *Reconciler) joinControlplane(ctx context.Context, scope *Scope) (ctrl.Result, error) {
...
func (r *Reconciler) resolveFiles(ctx context.Context, cfg *bootstrapv1.KubeadmConfig, cluster *clusterv1.Cluster) ([]bootstrapv1.File, error) {
...
func (r *Reconciler) resolveSecretFileContent(ctx context.Context, ns string, source bootstrapv1.File) ([]byte, error) {
...
// along the way.
func (r *Reconciler) resolveUsers(ctx context.Context, cfg *bootstrapv1.KubeadmConfig) ([]bootstrapv1.User, error) {
...
func (r *Reconciler) resolveDiscoveryKubeConfig(cfg bootstrapv1.FileDiscovery) (*bootstrapv1.File, error) {
...
func (r *Reconciler) resolveSecretPasswordContent(ctx context.Context, ns string, source bootstrapv1.User) ([]byte, error) {
	secret := &corev1.Secret{}
...
func (r *Reconciler) skipTokenRefreshIfExpiringAfter() time.Duration {
...
func (r *Reconciler) tokenCheckRefreshOrRotationInterval() time.Duration {
...
func (r *Reconciler) ClusterToKubeadmConfigs(ctx context.Context, o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *Reconciler) MachineToBootstrapMapFunc(_ context.Context, o client.Object) []ctrl.Request {
...
// request for reconciliation of KubeadmConfig.
func (r *Reconciler) MachinePoolToBootstrapMapFunc(_ context.Context, o client.Object) []ctrl.Request {
...
func (r *Reconciler) reconcileDiscovery(ctx context.Context, cluster *clusterv1.Cluster, config *bootstrapv1.KubeadmConfig, certificates secret.Certificates) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) reconcileDiscoveryFile(ctx context.Context, cluster *clusterv1.Cluster, config *bootstrapv1.KubeadmConfig, certificates secret.Certificates) (ctrl.Result, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) computeClusterConfigurationAndAdditionalData(cluster *clusterv1.Cluster, machine *clusterv1.Machine, clusterConfiguration *bootstrapv1.ClusterConfiguration, initConfiguration *bootstrapv1.InitConfiguration) *upstream.AdditionalData {
...
func (r *Reconciler) storeBootstrapData(ctx context.Context, scope *Scope, data []byte) error {
	log := ctrl.LoggerFrom(ctx)
...
func (r *Reconciler) ensureBootstrapSecretOwnersRef(ctx context.Context, scope *Scope) error {
	secret := &corev1.Secret{}
