...
Welcome to the Cluster API Release Lead Team onboarding documentation!

## Overview

- Explore CI Setup and Tools:
  - Gain some insights into how CI is setup in the Cluster API and tools used. You can check out CI Team onboarding [notes](../ci-signal-bug-triage-automation/README.md) for more details.
...
- Review the onboarding notes for both the Comms and CI Lead teams:
  - Check out the onboarding notes of [Comms](../communications/README.md) and [CI Signal](../ci-signal-bug-triage-automation/README.md) teams.
