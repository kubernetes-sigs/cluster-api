...
# This script verifies (or fixes, with the `fix` argument) Starlark formatting of the Tiltfile via buildifier.
...
BUILDIFIER="${ROOT_PATH}/hack/tools/bin/buildifier/${VERSION}/buildifier"
