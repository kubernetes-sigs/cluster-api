...
# For tilt we a small distroless debug image; using base instead of static so we can build in both ways; it is not
# possible to use -nonroot because CAPD needs access to the docker socker.
