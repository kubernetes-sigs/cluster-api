...
func (u *providerUpgrader) Plan() ([]UpgradePlan, error) {
	...
	for _, managementGroup := range managementGroups {
		...
		// e.g if the core provider supports v1alpha4, all the providers in the same management group should support v1alpha4 as well;
		// all the providers in the management group can upgrade to the latest release supporting v1alpha4, or if available,
		// or if available, all the providers in the management group can upgrade to the latest release supporting v1alpha5
