...
func (in *MachineDeploymentClass) DeepCopyInto(out *MachineDeploymentClass) {
	*out = *in
	...
	if in.MachineNaming != nil {
		...
		*out = new(MachineDeploymentClassMachineNamingStrategy)
		(*in).DeepCopyInto(*out)
	}
	if in.NodeDrainTimeout != nil {
		in, out := &in.NodeDrainTimeout, &out.NodeDrainTimeout
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineDeploymentClassMachineNamingStrategy) DeepCopyInto(out *MachineDeploymentClassMachineNamingStrategy) {
	*out = *in
	if in.Template != nil {
		in, out := &in.Template, &out.Template
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineDeploymentClassMachineNamingStrategy.
func (in *MachineDeploymentClassMachineNamingStrategy) DeepCopy() *MachineDeploymentClassMachineNamingStrategy {
	if in == nil {
		return nil
	}
	out := new(MachineDeploymentClassMachineNamingStrategy)
...
func (in *MachineDeploymentTopology) DeepCopyInto(out *MachineDeploymentTopology) {
	*out = *in
	...
	if in.MachineNaming != nil {
		in, out := &in.MachineNaming, &out.MachineNaming
		*out = new(MachineDeploymentTopologyMachineNamingStrategy)
		(*in).DeepCopyInto(*out)
	}
	if in.Variables != nil {
		in, out := &in.Variables, &out.Variables
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineDeploymentTopologyMachineNamingStrategy) DeepCopyInto(out *MachineDeploymentTopologyMachineNamingStrategy) {
	*out = *in
	if in.Template != nil {
		in, out := &in.Template, &out.Template
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineDeploymentTopologyMachineNamingStrategy.
func (in *MachineDeploymentTopologyMachineNamingStrategy) DeepCopy() *MachineDeploymentTopologyMachineNamingStrategy {
	if in == nil {
		return nil
	}
	out := new(MachineDeploymentTopologyMachineNamingStrategy)
