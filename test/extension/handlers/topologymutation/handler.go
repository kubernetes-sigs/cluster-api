...
func GeneratePatches(scheme *runtime.Scheme) func(context.Context, *runtimehooksv1.GeneratePatchesRequest, *runtimehooksv1.GeneratePatchesResponse) {
	decoder := serializer.NewCodecFactory(scheme).UniversalDecoder(infrav1.GroupVersion)

	return func(ctx context.Context, req *runtimehooksv1.GeneratePatchesRequest, resp *runtimehooksv1.GeneratePatchesResponse) {
		log := ctrl.LoggerFrom(ctx)
		log.Info("GeneratePatches called")

		walk(decoder, req, resp, func(obj runtime.Object, variables map[string]apiextensionsv1.JSON) error {
...
func ValidateTopology(_ *runtime.Scheme) func(context.Context, *runtimehooksv1.ValidateTopologyRequest, *runtimehooksv1.ValidateTopologyResponse) {
	return func(ctx context.Context, req *runtimehooksv1.ValidateTopologyRequest, resp *runtimehooksv1.ValidateTopologyResponse) {
		log := ctrl.LoggerFrom(ctx)
