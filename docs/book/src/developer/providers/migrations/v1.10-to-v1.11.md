...
- The following `spec` fields have been removed because not necessary (Cluster API automatically applies the right gvk when generating kubeadm config files):
...
- The following `spec.kubeadmConfigSpec` fields have been removed because not necessary (Cluster API automatically applies the right gvk when generating kubeadm config files):
  - `clusterConfiguration.apiVersion`, `clusterConfiguration.kind`
  - `initConfiguration.apiVersion`, `initConfiguration.kind`
  - `joinConfiguration.apiVersion`, `joinConfiguration.kind`
