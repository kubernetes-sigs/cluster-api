...
type ImageMeta struct {
	// NewImageRepository sets the container registry to pull the haproxy image from.
	// if not set, "kindest" will be used instead.
	// +optional
	NewImageRepository string `json:"newImageRepository,omitempty"`

	// NewField allows to specify a tag for the haproxy image.
