...
func (webhook *KubeadmControlPlaneTemplate) ValidateUpdate(_ context.Context, oldK, newK *controlplanev1.KubeadmControlPlaneTemplate) (admission.Warnings, error) {
	...
	bootstrapadmission.ApplyPreviousKubeadmConfigDefaults(&oldK.Spec.Template.Spec.KubeadmConfigSpec)
	bootstrapadmission.ApplyPreviousKubeadmConfigDefaults(&newK.Spec.Template.Spec.KubeadmConfigSpec)
