...
// are paused.
func (r *ReconcileMachineDeployment) sync(d *machinev1alpha1.MachineDeployment, msList []*machinev1alpha1.MachineSet, machineMap map[types.UID]*machinev1alpha1.MachineList) error {
...
func (r *ReconcileMachineDeployment) getAllMachineSetsAndSyncRevision(d *machinev1alpha1.MachineDeployment, msList []*machinev1alpha1.MachineSet, machineMap map[types.UID]*machinev1alpha1.MachineList, createIfNotExisted bool) (*machinev1alpha1.MachineSet, []*machinev1alpha1.MachineSet, error) {
...
func (r *ReconcileMachineDeployment) getNewMachineSet(d *machinev1alpha1.MachineDeployment, msList, oldMSs []*machinev1alpha1.MachineSet, createIfNotExisted bool) (*machinev1alpha1.MachineSet, error) {
	...
	if existingNewMS != nil {
		...
		err := r.updateMachineDeployment(d, func(innerDeployment *machinev1alpha1.MachineDeployment) {
	...
	newMS := machinev1alpha1.MachineSet{
...
func (r *ReconcileMachineDeployment) scale(deployment *machinev1alpha1.MachineDeployment, newMS *machinev1alpha1.MachineSet, oldMSs []*machinev1alpha1.MachineSet) error {
...
func (r *ReconcileMachineDeployment) syncDeploymentStatus(allMSs []*machinev1alpha1.MachineSet, newMS *machinev1alpha1.MachineSet, d *machinev1alpha1.MachineDeployment) error {
...
func calculateStatus(allMSs []*machinev1alpha1.MachineSet, newMS *machinev1alpha1.MachineSet, deployment *machinev1alpha1.MachineDeployment) machinev1alpha1.MachineDeploymentStatus {
	...
	status := machinev1alpha1.MachineDeploymentStatus{
		...
		UpdatedReplicas:     dutil.GetActualReplicaCountForMachineSets([]*machinev1alpha1.MachineSet{newMS}),
...
func (r *ReconcileMachineDeployment) scaleMachineSet(ms *machinev1alpha1.MachineSet, newScale int32, deployment *machinev1alpha1.MachineDeployment) (bool, error) {
	if ms.Spec.Replicas == nil {
...
func (r *ReconcileMachineDeployment) scaleMachineSetOperation(ms *machinev1alpha1.MachineSet, newScale int32, deployment *machinev1alpha1.MachineDeployment, scaleOperation string) (bool, error) {
	if ms.Spec.Replicas == nil {
		return false, fmt.Errorf("spec replicas for machine set %v is nil, this is unexpected", ms.Name)
	}
...
func (r *ReconcileMachineDeployment) cleanupDeployment(oldMSs []*machinev1alpha1.MachineSet, deployment *machinev1alpha1.MachineDeployment) error {
	if deployment.Spec.RevisionHistoryLimit == nil {
		return nil
	}

	// Avoid deleting machine set with deletion timestamp set
	aliveFilter := func(ms *machinev1alpha1.MachineSet) bool {
...
// msList should come from getMachineSetsForDeployment(d).
// machineMap should come from getMachineMapForDeployment(d, msList).
func (r *ReconcileMachineDeployment) isScalingEvent(d *machinev1alpha1.MachineDeployment, msList []*machinev1alpha1.MachineSet, machineMap map[types.UID]*machinev1alpha1.MachineList) (bool, error) {
...
func (r *ReconcileMachineDeployment) updateMachineDeployment(d *machinev1alpha1.MachineDeployment, modify func(*machinev1alpha1.MachineDeployment)) error {
	return updateMachineDeployment(r.Client, d, modify)
}

// We have this as standalone variant to be able to use it from the tests
func updateMachineDeployment(c client.Client, d *machinev1alpha1.MachineDeployment, modify func(*machinev1alpha1.MachineDeployment)) error {
	dCopy := d.DeepCopy()
	modify(dCopy)
	...
	err := retry.RetryOnConflict(retry.DefaultBackoff, func() error {
		...
		machinev1alpha1.PopulateDefaultsMachineDeployment(d)
		// Apply modifications
		modify(d)
