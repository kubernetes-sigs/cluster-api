...
func TestExtensionConfigValidationFeatureGated(t *testing.T) {
	...
	updatedExtension.Spec.ClientConfig.URL = "https://a-new-extension-address.com"
	tests := []struct {
		name        string
...
func TestExtensionConfigDefault(t *testing.T) {
	...
	t.Run("for Extension", testutil.CustomDefaultValidateTest[*runtimev1.ExtensionConfig](ctx, extensionConfig, extensionConfigWebhook))
...
func TestExtensionConfigValidate(t *testing.T) {
	...
	updatedExtension.Spec.ClientConfig.URL = "https://a-in-extension-address.com"

	extensionWithoutURLOrService := extensionWithURL.DeepCopy()
	extensionWithoutURLOrService.Spec.ClientConfig.URL = ""

	extensionWithInvalidServicePath := extensionWithService.DeepCopy()
	extensionWithInvalidServicePath.Spec.ClientConfig.Service.Path = "https://example.com"
	...
	badURLExtension.Spec.ClientConfig.URL = "https//extension-address.com"

	badSchemeExtension := extensionWithURL.DeepCopy()
	badSchemeExtension.Spec.ClientConfig.URL = "unknown://extension-address.com"
