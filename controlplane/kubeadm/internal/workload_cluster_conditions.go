...
func (w *Workload) UpdateEtcdConditions(ctx context.Context, controlPlane *ControlPlane) {
	ctx, span := traceutil.Start(ctx, "Workload.UpdateEtcdConditions")
	defer span.End()
...
func (w *Workload) updateManagedEtcdConditions(ctx context.Context, controlPlane *ControlPlane) {
	ctx, span := traceutil.Start(ctx, "Workload.updateManagedEtcdConditions")
	defer span.End()
...
func (w *Workload) getCurrentEtcdMembers(ctx context.Context, machine *clusterv1.Machine, nodeName string) ([]*etcd.Member, error) {
	ctx, span := traceutil.Start(ctx, "Workload.getCurrentEtcdMembers")
	defer span.End()
...
func (w *Workload) UpdateStaticPodConditions(ctx context.Context, controlPlane *ControlPlane) {
	ctx, span := traceutil.Start(ctx, "Workload.UpdateStaticPodConditions")
	defer span.End()
...
func (w *Workload) updateStaticPodCondition(ctx context.Context, machine *clusterv1.Machine, node corev1.Node, component string, staticPodCondition clusterv1.ConditionType) {
	ctx, span := traceutil.Start(ctx, "Workload.updateStaticPodCondition")
	defer span.End()
