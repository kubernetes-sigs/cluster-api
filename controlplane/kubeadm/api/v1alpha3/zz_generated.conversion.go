...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RollingUpdate)(nil), (*v1alpha4.RollingUpdate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_RollingUpdate_To_v1alpha4_RollingUpdate(a.(*RollingUpdate), b.(*v1alpha4.RollingUpdate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha4.RollingUpdate)(nil), (*RollingUpdate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_RollingUpdate_To_v1alpha3_RollingUpdate(a.(*v1alpha4.RollingUpdate), b.(*RollingUpdate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*RolloutStrategy)(nil), (*v1alpha4.RolloutStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_RolloutStrategy_To_v1alpha4_RolloutStrategy(a.(*RolloutStrategy), b.(*v1alpha4.RolloutStrategy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha4.RolloutStrategy)(nil), (*RolloutStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_RolloutStrategy_To_v1alpha3_RolloutStrategy(a.(*v1alpha4.RolloutStrategy), b.(*RolloutStrategy), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*v1alpha4.KubeadmControlPlaneStatus)(nil), (*KubeadmControlPlaneStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha3_KubeadmControlPlaneSpec_To_v1alpha4_KubeadmControlPlaneSpec(in *KubeadmControlPlaneSpec, out *v1alpha4.KubeadmControlPlaneSpec, s conversion.Scope) error {
	...
	out.RolloutStrategy = (*v1alpha4.RolloutStrategy)(unsafe.Pointer(in.RolloutStrategy))
	return nil
}
...
func autoConvert_v1alpha3_RollingUpdate_To_v1alpha4_RollingUpdate(in *RollingUpdate, out *v1alpha4.RollingUpdate, s conversion.Scope) error {
...
func Convert_v1alpha3_RollingUpdate_To_v1alpha4_RollingUpdate(in *RollingUpdate, out *v1alpha4.RollingUpdate, s conversion.Scope) error {
	return autoConvert_v1alpha3_RollingUpdate_To_v1alpha4_RollingUpdate(in, out, s)
}

func autoConvert_v1alpha4_RollingUpdate_To_v1alpha3_RollingUpdate(in *v1alpha4.RollingUpdate, out *RollingUpdate, s conversion.Scope) error {
	out.MaxSurge = (*intstr.IntOrString)(unsafe.Pointer(in.MaxSurge))
	return nil
}

// Convert_v1alpha4_RollingUpdate_To_v1alpha3_RollingUpdate is an autogenerated conversion function.
func Convert_v1alpha4_RollingUpdate_To_v1alpha3_RollingUpdate(in *v1alpha4.RollingUpdate, out *RollingUpdate, s conversion.Scope) error {
	return autoConvert_v1alpha4_RollingUpdate_To_v1alpha3_RollingUpdate(in, out, s)
}

func autoConvert_v1alpha3_RolloutStrategy_To_v1alpha4_RolloutStrategy(in *RolloutStrategy, out *v1alpha4.RolloutStrategy, s conversion.Scope) error {
	out.Type = v1alpha4.RolloutStrategyType(in.Type)
	out.RollingUpdate = (*v1alpha4.RollingUpdate)(unsafe.Pointer(in.RollingUpdate))
	return nil
}

// Convert_v1alpha3_RolloutStrategy_To_v1alpha4_RolloutStrategy is an autogenerated conversion function.
func Convert_v1alpha3_RolloutStrategy_To_v1alpha4_RolloutStrategy(in *RolloutStrategy, out *v1alpha4.RolloutStrategy, s conversion.Scope) error {
	return autoConvert_v1alpha3_RolloutStrategy_To_v1alpha4_RolloutStrategy(in, out, s)
}

func autoConvert_v1alpha4_RolloutStrategy_To_v1alpha3_RolloutStrategy(in *v1alpha4.RolloutStrategy, out *RolloutStrategy, s conversion.Scope) error {
...
func Convert_v1alpha4_RolloutStrategy_To_v1alpha3_RolloutStrategy(in *v1alpha4.RolloutStrategy, out *RolloutStrategy, s conversion.Scope) error {
	return autoConvert_v1alpha4_RolloutStrategy_To_v1alpha3_RolloutStrategy(in, out, s)
}
