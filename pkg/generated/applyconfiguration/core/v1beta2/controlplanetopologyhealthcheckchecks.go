...
// ControlPlaneTopologyHealthCheckChecksApplyConfiguration represents a declarative configuration of the ControlPlaneTopologyHealthCheckChecks type for use
// with apply.
//
// ControlPlaneTopologyHealthCheckChecks are the checks that are used to evaluate if a control plane Machine is healthy.
type ControlPlaneTopologyHealthCheckChecksApplyConfiguration struct {
...
// ControlPlaneTopologyHealthCheckChecksApplyConfiguration constructs a declarative configuration of the ControlPlaneTopologyHealthCheckChecks type for use with
// apply.
func ControlPlaneTopologyHealthCheckChecks() *ControlPlaneTopologyHealthCheckChecksApplyConfiguration {
	return &ControlPlaneTopologyHealthCheckChecksApplyConfiguration{}
}
...
func (b *ControlPlaneTopologyHealthCheckChecksApplyConfiguration) WithNodeStartupTimeoutSeconds(value int32) *ControlPlaneTopologyHealthCheckChecksApplyConfiguration {
...
func (b *ControlPlaneTopologyHealthCheckChecksApplyConfiguration) WithUnhealthyNodeConditions(values ...*UnhealthyNodeConditionApplyConfiguration) *ControlPlaneTopologyHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *ControlPlaneTopologyHealthCheckChecksApplyConfiguration) WithUnhealthyMachineConditions(values ...*UnhealthyMachineConditionApplyConfiguration) *ControlPlaneTopologyHealthCheckChecksApplyConfiguration {
	for i := range values {
		if values[i] == nil {
