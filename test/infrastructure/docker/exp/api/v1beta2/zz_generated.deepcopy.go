...
import (
	...
	cluster_apiapiv1beta2 "sigs.k8s.io/cluster-api/api/v1beta2"
...
func (in *DockerMachinePoolInstanceStatus) DeepCopyInto(out *DockerMachinePoolInstanceStatus) {
	*out = *in
	if in.Addresses != nil {
		...
		*out = make([]cluster_apiapiv1beta2.MachineAddress, len(*in))
		copy(*out, *in)
	}
...
func (in *DockerMachinePoolStatus) DeepCopyInto(out *DockerMachinePoolStatus) {
	*out = *in
	...
	if in.Conditions != nil {
		...
		*out = make(cluster_apiapiv1beta2.Conditions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
