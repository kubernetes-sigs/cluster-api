...
import (
	...
	v1alpha1 "k8s.io/kube-deploy/cluster-api/client/clientset/versioned/typed/cluster/v1alpha1"
)
...
func (c *FakeClusterV1alpha1) Machines() v1alpha1.MachineInterface {
