...
func (r *DockerMachineReconciler) Reconcile(req ctrl.Request) (_ ctrl.Result, rerr error) {
	...
	return r.reconcileNormal(ctx, machine, dockerMachine, externalMachine, externalLoadBalancer, cluster, log)
}
...
func (r *DockerMachineReconciler) reconcileNormal(ctx context.Context, machine *clusterv1.Machine, dockerMachine *infrav1.DockerMachine, externalMachine *docker.Machine, externalLoadBalancer *docker.LoadBalancer, cluster *clusterv1.Cluster, log logr.Logger) (res ctrl.Result, retErr error) {
