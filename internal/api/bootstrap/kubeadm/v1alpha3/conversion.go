...
func Convert_v1beta2_Partition_To_v1alpha3_Partition(in *bootstrapv1.Partition, out *Partition, s apimachineryconversion.Scope) error {
...
func Convert_v1alpha3_KubeadmConfigSpec_To_v1beta2_KubeadmConfigSpec(in *KubeadmConfigSpec, out *bootstrapv1.KubeadmConfigSpec, s apimachineryconversion.Scope) error {
	...
	if err := autoConvert_v1alpha3_KubeadmConfigSpec_To_v1beta2_KubeadmConfigSpec(in, out, s); err != nil {
		return err
	}
	...
	if in.DiskSetup != nil {
		if err := Convert_v1alpha3_DiskSetup_To_v1beta2_DiskSetup(in.DiskSetup, &out.DiskSetup, s); err != nil {
			return err
		}
	}
	if in.NTP != nil {
		if err := Convert_v1alpha3_NTP_To_v1beta2_NTP(in.NTP, &out.NTP, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1alpha3_BootstrapToken_To_v1beta2_BootstrapToken(in *BootstrapToken, out *bootstrapv1.BootstrapToken, s apimachineryconversion.Scope) error {
	...
	if in.Token != nil {
		if err := autoConvert_v1alpha3_BootstrapTokenString_To_v1beta2_BootstrapTokenString(in.Token, &out.Token, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_KubeadmConfigSpec_To_v1alpha3_KubeadmConfigSpec(in *bootstrapv1.KubeadmConfigSpec, out *KubeadmConfigSpec, s apimachineryconversion.Scope) error {
	...
	if err := autoConvert_v1beta2_KubeadmConfigSpec_To_v1alpha3_KubeadmConfigSpec(in, out, s); err != nil {
		return err
	}
	...
	if !reflect.DeepEqual(in.DiskSetup, bootstrapv1.DiskSetup{}) {
		...
		if err := Convert_v1beta2_DiskSetup_To_v1alpha3_DiskSetup(&in.DiskSetup, out.DiskSetup, s); err != nil {
			return err
		}
	}
	if !reflect.DeepEqual(in.NTP, bootstrapv1.NTP{}) {
		out.NTP = &NTP{}
		if err := Convert_v1beta2_NTP_To_v1alpha3_NTP(&in.NTP, out.NTP, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_BootstrapToken_To_v1alpha3_BootstrapToken(in *bootstrapv1.BootstrapToken, out *BootstrapToken, s apimachineryconversion.Scope) error {
	...
	if !reflect.DeepEqual(in.Token, bootstrapv1.BootstrapTokenString{}) {
		...
		if err := autoConvert_v1beta2_BootstrapTokenString_To_v1alpha3_BootstrapTokenString(&in.Token, out.Token, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_DNS_To_v1alpha3_DNS(in *bootstrapv1.DNS, out *DNS, _ apimachineryconversion.Scope) error {
	out.ImageRepository = in.ImageRepository
	out.ImageTag = in.ImageTag
	return nil
}

func Convert_v1alpha3_Etcd_To_v1beta2_Etcd(in *Etcd, out *bootstrapv1.Etcd, s apimachineryconversion.Scope) error {
	if in.Local != nil {
		if err := Convert_v1alpha3_LocalEtcd_To_v1beta2_LocalEtcd(in.Local, &out.Local, s); err != nil {
			return err
		}
	}
	if in.External != nil {
		if err := Convert_v1alpha3_ExternalEtcd_To_v1beta2_ExternalEtcd(in.External, &out.External, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_Etcd_To_v1alpha3_Etcd(in *bootstrapv1.Etcd, out *Etcd, s apimachineryconversion.Scope) error {
	if in.Local.IsDefined() {
		out.Local = &LocalEtcd{}
		if err := Convert_v1beta2_LocalEtcd_To_v1alpha3_LocalEtcd(&in.Local, out.Local, s); err != nil {
			return err
		}
	}
	if in.External.IsDefined() {
		out.External = &ExternalEtcd{}
		if err := Convert_v1beta2_ExternalEtcd_To_v1alpha3_ExternalEtcd(&in.External, out.External, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_Discovery_To_v1alpha3_Discovery(in *bootstrapv1.Discovery, out *Discovery, s apimachineryconversion.Scope) error {
	if err := autoConvert_v1beta2_Discovery_To_v1alpha3_Discovery(in, out, s); err != nil {
		return err
	}
	if !reflect.DeepEqual(in.BootstrapToken, bootstrapv1.BootstrapTokenDiscovery{}) {
		out.BootstrapToken = &BootstrapTokenDiscovery{}
		if err := Convert_v1beta2_BootstrapTokenDiscovery_To_v1alpha3_BootstrapTokenDiscovery(&in.BootstrapToken, out.BootstrapToken, s); err != nil {
			return err
		}
	}
	if !reflect.DeepEqual(in.File, bootstrapv1.FileDiscovery{}) {
		out.File = &FileDiscovery{}
		if err := Convert_v1beta2_FileDiscovery_To_v1alpha3_FileDiscovery(&in.File, out.File, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1alpha3_File_To_v1beta2_File(in *File, out *bootstrapv1.File, s apimachineryconversion.Scope) error {
	if err := autoConvert_v1alpha3_File_To_v1beta2_File(in, out, s); err != nil {
		return err
	}
	if in.ContentFrom != nil {
		if err := Convert_v1alpha3_FileSource_To_v1beta2_FileSource(in.ContentFrom, &out.ContentFrom, s); err != nil {
			return err
		}
	}
	return nil
...
func Convert_v1beta2_File_To_v1alpha3_File(in *bootstrapv1.File, out *File, s apimachineryconversion.Scope) error {
	...
	if err := autoConvert_v1beta2_File_To_v1alpha3_File(in, out, s); err != nil {
		return err
	}
	if in.ContentFrom.IsDefined() {
		out.ContentFrom = &FileSource{}
		if err := Convert_v1beta2_FileSource_To_v1alpha3_FileSource(&in.ContentFrom, out.ContentFrom, s); err != nil {
			return err
		}
	}
	return nil
