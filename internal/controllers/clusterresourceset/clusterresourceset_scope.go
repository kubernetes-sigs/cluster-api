...
func reconcileScopeForResource(
	crs *v1beta1.ClusterResourceSet,
	resourceRef v1beta1.ResourceRef,
	resourceSetBinding *v1beta1.ResourceSetBinding,
...
func newResourceReconcileScope(
	clusterResourceSet *v1beta1.ClusterResourceSet,
	resourceRef v1beta1.ResourceRef,
	resourceSetBinding *v1beta1.ResourceSetBinding,
	normalizedData [][]byte,
	...
	switch v1beta1.ClusterResourceSetStrategy(clusterResourceSet.Spec.Strategy) {
	case v1beta1.ClusterResourceSetStrategyApplyOnce:
		return &reconcileApplyOnceScope{base}
	case v1beta1.ClusterResourceSetStrategyReconcile:
