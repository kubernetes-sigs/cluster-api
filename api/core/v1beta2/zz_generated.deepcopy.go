...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineDeploymentRolloutGroup) DeepCopyInto(out *MachineDeploymentRolloutGroup) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineDeploymentRolloutGroup.
func (in *MachineDeploymentRolloutGroup) DeepCopy() *MachineDeploymentRolloutGroup {
	if in == nil {
		return nil
	}
	out := new(MachineDeploymentRolloutGroup)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkersTopologyRolloutSpec) DeepCopyInto(out *WorkersTopologyRolloutSpec) {
	*out = *in
	if in.Groups != nil {
		...
		*out = make([]MachineDeploymentRolloutGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
