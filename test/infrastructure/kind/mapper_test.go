...
func TestGetKubernetesVersion(t *testing.T) {
	...
	g.Expect(got).To(Equal([]string{
		...
		"v1.24.15", "v1.24.17",
		"v1.25.11", "v1.25.16",
		"v1.26.6", "v1.26.13", "v1.26.14", "v1.26.15",
		"v1.27.3", "v1.27.10", "v1.27.11", "v1.27.13", "v1.27.16",
		...
		"v1.33.0", "v1.33.1", "v1.33.4", "v1.33.7", "v1.33.12",
		"v1.34.0", "v1.34.3", "v1.34.8", "v1.34.11",
		"v1.35.0", "v1.35.5", "v1.35.8",
		"v1.36.1", "v1.36.4",
		"v1.37.0",
	}))
}
